...
describe('consumeClaudeBudget', () => {
  ...
  it('1 日の上限まで消費でき、超えたら false を返す', () => {
    ...
    const day = new Date('2026-07-11T10:00:00Z');
  ...
  it('日付が変わったらリセットされる', () => {
    ...
    expect(consumeClaudeBudget(new Date('2026-07-11T10:00:00Z'))).toBe(true);
    expect(consumeClaudeBudget(new Date('2026-07-11T23:00:00Z'))).toBe(false);
    expect(consumeClaudeBudget(new Date('2026-07-12T00:10:00Z'))).toBe(true);
  });
